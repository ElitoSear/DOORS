...
execute at @s if score @s guiding_light_message matches 580 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a120.first_1"}'}
...
execute at @s if score @s guiding_light_message matches 710 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a120.first_2"}'}
...
execute at @s if score @s guiding_light_message matches 840 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a120.first_3"}'}
...
execute if score @s guiding_light_message matches 1040 run function doors:death/untag