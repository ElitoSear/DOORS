...
execute if score @s guiding_light_message matches 570 run stopsound @s * doors:music.guiding_light
execute if score @s guiding_light_message matches 570 at @s run playsound doors:music.guiding_light_end master @s ~ ~ ~ 0.6
