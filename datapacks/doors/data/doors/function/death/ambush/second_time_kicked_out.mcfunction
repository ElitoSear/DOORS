...
execute if score @s guiding_light_message matches 410 run stopsound @s * doors:music.guiding_light
execute if score @s guiding_light_message matches 410 at @s run playsound doors:music.guiding_light_end master @s ~ ~ ~ 0.6
