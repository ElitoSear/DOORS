...
execute unless entity @e[type=armor_stand,tag=a120] run stopsound @a[tag=atrooms] * doors:entity.a120.far
execute unless entity @e[type=armor_stand,tag=a120] run stopsound @a[tag=atrooms] * doors:entity.a120.near
