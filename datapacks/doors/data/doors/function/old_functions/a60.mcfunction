...
execute unless entity @e[type=armor_stand,tag=a60] run stopsound @a[tag=atrooms] * doors:entity.a60.far
execute unless entity @e[type=armor_stand,tag=a60] run stopsound @a[tag=atrooms] * doors:entity.a60.near
