...
execute as @a[distance=..1,tag=atlibrary] at @s run playsound doors:music.unhinged_end voice @s
execute as @a[distance=..1,tag=atlibrary] at @s run scoreboard players reset @s librarymusic
execute as @a[distance=..1,tag=atlibrary] at @s run stopsound @s * doors:music.unhinged
