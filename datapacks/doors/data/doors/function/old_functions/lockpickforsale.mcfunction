...
execute if entity @s[tag=!sold,nbt={interaction:{}}] at @s on target if entity @s[scores={gold=..149}] run playsound doors:misc.click master @s
...
execute if entity @s[nbt={interaction:{}},tag=!sold] at @s on target if entity @s[tag=boughtlockpick] run playsound doors:misc.gold_decrease master @s
