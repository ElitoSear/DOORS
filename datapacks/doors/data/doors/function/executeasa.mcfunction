...
execute if entity @s[scores={HidingTime=200}] at @s run playsound custom:misc.get_out master @s ~ ~ ~ 1 1
execute if entity @s[scores={Hiding=0}] run scoreboard players reset @s HidingTime
execute if entity @s[scores={Hiding=0}] at @s unless entity @s[scores={kickedout=1..}] run stopsound @s master custom:misc.get_out
stopsound @s[gamemode=spectator] master custom:misc.get_out
#Eyes
...
execute if entity @s[scores={HidingTime=1}] at @s if entity @s[nbt={RootVehicle:{Entity:{Tags:["wardrobe"]}}}] run playsound custom:misc.wardrobe_open master @s ~ ~ ~ 0.6
execute if entity @s[scores={HidingTime=1}] at @s if entity @s[nbt={RootVehicle:{Entity:{Tags:["figurewardrobe"]}}}] run playsound custom:misc.wardrobe_open master @s ~ ~ ~ 0.6
execute if entity @s[scores={HidingTime=1}] at @s if entity @s[nbt={RootVehicle:{Entity:{Tags:["bed"]}}}] run playsound custom:misc.bed_hide master @s ~ ~ ~ 0.6
...
execute at @s positioned ~ ~-0.45 ~ unless entity @s[nbt={RootVehicle:{Entity:{Tags:["bed"]}}}] if entity @e[tag=bed,distance=..0.5] run execute as @e[tag=bed,sort=nearest,limit=1] at @s run playsound custom:misc.bed_hide master @p ~ ~ ~ 0.6 0.8
...
#Eyes Sound
execute if entity @s[scores={eyesspawn=2}] at @s run playsound custom:entity.eyes.spawn master @s
execute if entity @s[scores={eyesspawn=2}] at @s run scoreboard players add @s eyesspawn 1
execute if entity @s[scores={eyesdamagesound=2}] at @s run playsound custom:entity.eyes.damage master @s
execute if entity @s[scores={eyesdamagesound=2}] at @s run scoreboard players add @s eyesdamagesound 1
#Death Sound
execute if entity @s[scores={killed=2}] at @s run playsound custom:misc.death master @s
execute if entity @s[scores={killed=2}] at @s run stopsound @s * custom:entity.halt.ambience
execute if entity @s[scores={killed=2}] at @s run stopsound @s * custom:music.here_i_come
execute if entity @s[scores={killed=2}] at @s run stopsound @s * custom:music.the_rooms
execute if entity @s[scores={killed=2}] run gamemode spectator @s
scoreboard players add @s[scores={killed=1..4}] killed 1
#Elevator Sound
execute if entity @s[scores={lobbyelevatortime=2}] at @s run playsound custom:misc.player_on_elevator master @a
#Holding Item Sound
execute if entity @s[nbt={SelectedItem:{id:"minecraft:soul_torch",tag:{CustomModelData:3}}}] if entity @e[scores={rush=2}] run playsound custom:candle_burned master @s
execute if entity @s[scores={candlesound=1}] at @s run playsound custom:item.candle master @s
...
execute if entity @s[scores={lightersound=1}] at @s run playsound custom:item.lighter master @s
...
execute if entity @s[scores={keysound=1}] at @s run playsound custom:item.key master @s
...
execute if entity @s[scores={electricalkeysound=1}] at @s run playsound custom:item.key master @s
...
execute if entity @s[scores={golddetection=1..}] at @s run playsound custom:misc.gold_increase master @s
execute store result score @s golddetection run clear @s minecraft:gold_ingot
...
#Dawn of the Doors
execute if entity @s[scores={lobbytime=2}] at @s run playsound custom:music.dawn_of_the_doors voice @s
...
execute if entity @s[scores={timothytriggered=2}] at @s run playsound custom:entity.timothy.jumpscare master @s
execute if entity @s[scores={timothytriggered=2}] run advancement grant @s only doors:achievements/achievement14
execute if entity @s[scores={timothytriggered=2}] at @s run playsound custom:misc.ear_ringing master @s
...
execute if entity @s[scores={snaretrap=3}] at @s run playsound custom:misc.snare_trap master @s ~ ~ ~ 0.6
...
execute if entity @s[gamemode=adventure,scores={darkroomsound=2}] at @s run playsound custom:misc.darkroom master @s
...
execute if score @s screechtime matches 2 at @s run playsound custom:entity.screech.pre_psst master @s ~ ~ ~ 0.6
...
execute if entity @s[gamemode=adventure] at @s if entity @e[scores={reception=1..}] run scoreboard players add @e[tag=ishiddenkey,distance=..10] shimmering 1
    ...
    #Sounds
#Rift Sound
execute if entity @s[scores={riftsound=2}] at @e[tag=rift] run playsound custom:misc.rift master @s
...
execute at @e[tag=rift] run execute at @e[tag=rift] if entity @s[distance=16..17] run stopsound @s * custom:misc.rift
execute if entity @s[scores={riftsound=1780..}] run scoreboard players reset @s riftsound

execute if entity @s[scores={riftsoundlobby=2},tag=rifted] at @e[tag=riftlobby] run playsound custom:misc.rift master @s
...
execute if entity @s[tag=rifted] at @s if entity @e[tag=riftlobby,distance=16..17] run stopsound @s * custom:misc.rift
execute if entity @s[scores={riftsoundlobby=1780..}] run scoreboard players reset @s riftsoundlobby
#Rooms entrance sound
execute if entity @s[scores={roomsentrance=2}] at @e[tag=roomsentrance] run playsound custom:music.rooms_entrance master @s
...
execute at @s if entity @e[tag=roomsentrance,distance=16..17] run stopsound @s * custom:music.rooms_entrance
...
execute if entity @s[scores={roomsentrance=2}] at @e[tag=optionalexittext] run playsound custom:music.rooms_entrance master @s
...
execute at @s if entity @e[tag=optionalexittext,distance=16..17] run stopsound @s * custom:music.rooms_entrance
#Exit at the rooms sound
execute if entity @s[scores={roomsentrance=2}] at @e[tag=roomsexit] run playsound custom:music.rooms_entrance master @s
...
execute at @s if entity @e[tag=roomsexit,distance=16..17] run stopsound @s * custom:music.rooms_entrance
#Sound for every entity that hold the tag glins
execute at @s run execute as @e[tag=glints,sort=nearest,limit=1] at @s run playsound custom:misc.glint master @a[scores={glints=2}]
...
execute at @s run execute as @e[tag=glints,sort=nearest,limit=1] at @s run stopsound @a[distance=16..17] * custom:misc.glint
execute if entity @s[scores={glints=358..}] run scoreboard players reset @s glints
#Jeffs Jingle
execute if entity @s[scores={jeffsjingle=2}] at @e[tag=jeffsjingle] run playsound custom:music.jeffs_jingle master @s ^ ^ ^ 1.2
...
execute at @s if entity @e[tag=jeffsjingle,distance=16..17] run stopsound @s * custom:music.jeffs_jingle
execute if entity @s[scores={jeffsjingle=2398..}] run scoreboard players reset @s jeffsjingle
#Eyes sound
execute if entity @s[scores={eyessound=2}] at @e[tag=eyes] run playsound custom:entity.eyes.idle master @s
...
execute at @s if entity @e[tag=eyes,distance=7..8] run stopsound @s * custom:entity.eyes.idle
execute if entity @s[scores={eyessound=120..}] run scoreboard players reset @s eyessound
#Fnaf2 Sound
execute if entity @s[scores={fnaf2=1}] at @e[tag=window] positioned ~13.5 ~ ~5.5 run playsound custom:misc.fnaf_2 master @s
execute if entity @s[scores={fnaf2=192..}] at @s run scoreboard players reset @s fnaf2
#Stop Sound
stopsound @s[scores={killedbyrush=1..}] * custom:entity.rush.near
stopsound @s[scores={killedbyrush=1..}] * custom:entity.rush.far
stopsound @s[scores={killedbyrush=1..}] * custom:misc.darkroom
stopsound @s[scores={killedbyambush=1..}] * custom:entity.ambush.near
stopsound @s[scores={killedbyambush=1..}] * custom:entity.ambush.far
stopsound @s[scores={killed=4..}] * custom:entity.a60.near
stopsound @s[scores={killed=4..}] * custom:entity.a60.far
stopsound @s[scores={killed=4..}] * custom:entity.a120.near
stopsound @s[scores={killed=4..}] * custom:entity.a120.far
#Crucifixing
  #Rush
...
execute if entity @s[scores={killedbyrush=2}] at @s run playsound custom:misc.static master @s
...
execute if entity @s[scores={killedbyrush=110}] at @s run playsound custom:entity.rush.death master @s ~ ~ ~ 0.8
...
execute if entity @s[scores={killedbyambush=2}] at @s run playsound custom:entity.ambush.death master @s
...
execute if entity @s[scores={killedbyseek=2}] at @s run playsound custom:entity.seek.death master @s ~ ~ ~ 0.4
...
execute if entity @s[scores={killedbyseek=22}] at @s run stopsound @s * custom:music.here_i_come
execute if entity @s[scores={killedbyseek=22}] at @s run stopsound @s * custom:entity.seek.steps_close
execute if entity @s[scores={killedbyseek=22}] at @s run stopsound @s * custom:entity.seek.steps_far
...
execute if entity @s[tag=atseek] at @s unless entity @s[scores={killedbyseek=1..}] if entity @e[tag=seek,distance=12..13,scores={seekrun=1..}] run stopsound @s * custom:entity.seek.steps_close
execute if entity @s[tag=atseek] at @s unless entity @s[scores={killedbyseek=1..}] if entity @s[scores={seeksteps=1}] unless entity @e[tag=seek,scores={stop=1..}] run playsound custom:entity.seek.steps_close master @s
...
execute if entity @s[scores={roomsambience=2}] at @s run playsound custom:music.the_rooms voice @s
...
execute if entity @s[scores={atrooms=2}] at @s run playsound custom:misc.rooms_door master @s
...
execute if entity @s[scores={killedbya90=12}] at @s run playsound custom:entity.a90.death master @s
...
execute if entity @s[scores={killedbyfigure=2}] at @s run playsound custom:entity.figure.aggressive_growl master @s
execute if entity @s[scores={killedbyfigure=30}] at @s run playsound custom:entity.figure.death master @s
...
execute if entity @s[scores={killedbyfigure=32}] at @s run stopsound @s * custom:music.unhinged
execute if entity @s[scores={killedbyfigure=32}] at @s run stopsound @s * custom:music.unhinged_2
execute if entity @s[scores={killedbyfigure=32}] at @s run stopsound @s * custom:music.unhinged_2_intense
...
#Void
execute if entity @s[scores={voidtime=1184}] at @s run playsound custom:entity.void.jumpscare master @s
...
execute if entity @s[scores={voidtime=1200..}] at @s unless entity @s[predicate=doors:is_holding_crucifix] run playsound custom:misc.ear_ringinging master @s
...
execute if entity @s[tag=!atrooms,tag=!killed_by_seek] if entity @e[type=armor_stand,tag=seek] at @s run function doors:sounds/seek_steps
        ...
        #Dupe
execute if entity @s[scores={dupegrowl=2}] at @s at @e[tag=dupe,limit=1,sort=nearest] run playsound custom:entity.dupe.growl master @s ~ ~ ~ 0.5
