...
execute if entity @s[tag=!sold,nbt={interaction:{}}] at @s on target if entity @s[scores={gold=..99}] run playsound doors:misc.click master @s
...
execute if entity @s[nbt={interaction:{}},tag=!sold] at @s on target if entity @s[tag=boughtvitamins] run playsound doors:misc.gold_decrease master @s
