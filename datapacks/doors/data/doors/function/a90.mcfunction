execute if score a-90 a90randomizer matches 2050 as @a[tag=atrooms,scores={playercurrentroomsdoor=90..999}] at @s run playsound custom:entity.a90.spawn master @s
...
execute if score a-90 a90randomizer matches 2076 run execute as @a[tag=atrooms,tag=!a90i] unless score @s health matches ..18 if score @s playercurrentroomsdoor matches 90..999 at @s run playsound custom:misc.ear_ringing master @s ~ ~ ~ 0.6
