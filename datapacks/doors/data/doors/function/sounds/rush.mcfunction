...
execute if entity @e[tag=rush,distance=30..31] run stopsound @s * custom:entity.rush.near
execute if entity @s[scores={rushnear=1}] unless entity @e[tag=rush,tag=stop] run playsound custom:entity.rush.near master @s ~ ~ ~ 0.5
...
execute if entity @s[scores={rushfar=1}] unless entity @e[tag=rush,tag=stop] run playsound custom:entity.rush.far master @s ~ ~ ~ 0.5
