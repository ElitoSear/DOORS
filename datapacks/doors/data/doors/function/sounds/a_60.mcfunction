...
execute if entity @e[tag=a60,distance=16..17] run stopsound @s * doors:entity.a60.near
execute if score @s a60near matches 1 unless entity @e[tag=a60,scores={stop=1..}] run playsound doors:entity.a60.near master @s ~ ~ ~
execute if score @s a60near matches 166.. run scoreboard players reset @s a60near

scoreboard players add @s a60far 1
execute if score @s a60far matches 1 unless entity @e[tag=a60,scores={stop=1..}] run playsound doors:entity.a60.far master @s ~ ~ ~
