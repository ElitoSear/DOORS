...
execute if entity @s[scores={reception=110}] run execute as @a at @s run playsound doors:music.elevator_jam voice @s
execute if entity @s[scores={reception=702}] run execute as @e[tag=elevatordoor] at @s run setblock ~ ~-2 ~ redstone_torch
execute if entity @s[scores={reception=702}] run execute as @a at @s run playsound doors:misc.the_hotel master @s
