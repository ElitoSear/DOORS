...
execute on target if entity @s[nbt={SelectedItem:{id:"minecraft:flint",tag:{CustomModelData:13}}}] run data merge entity @e[tag=lockrooms1display,sort=nearest,limit=1] {view_range:0}
