#straight5 - size 18,8,15
#90
execute if entity @s[y_rotation=90] run function doors:structures/straight/5/90
#180
execute if entity @s[y_rotation=180] run function doors:structures/straight/5/180
#-90
execute if entity @s[y_rotation=-90] run function doors:structures/straight/5/-90
#0
execute if entity @s[y_rotation=0] run function doors:structures/straight/5/0
