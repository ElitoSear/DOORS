...
execute if entity @s[scores={crucifixed=1..}] at @s run stopsound @a * custom:entity.halt.ambience
execute if entity @s[scores={crucifixed=1..}] at @s run stopsound @a * custom:entity.halt.whisper
execute if entity @s[scores={crucifixed=1..}] at @s run stopsound @a * custom:entity.halt.whistles
execute if entity @s[scores={crucifixed=1..}] at @s run stopsound @a * custom:entity.halt.distorted
