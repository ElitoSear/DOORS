...
execute if entity @s[scores={turnaroundwarning=1}] at @s run playsound doors:entity.halt.turn_around master @s
...
execute if entity @s[scores={damagedbyhalt=1}] at @s run playsound doors:entity.halt.damage master @s
