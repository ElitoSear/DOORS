...
execute if entity @e[tag=ambush,distance=18..20] run stopsound @s * custom:entity.ambush.near
execute if entity @s[scores={ambushnear=1}] run playsound custom:entity.ambush.near master @s ~ ~ ~ 0.5
execute if entity @s[scores={ambushnear=156..}] run scoreboard players reset @s ambushnear

scoreboard players add @s ambushfar 1
execute if entity @s[scores={ambushfar=1}] run playsound custom:entity.ambush.far master @s ~ ~ ~ 0.5
