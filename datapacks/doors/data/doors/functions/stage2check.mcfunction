...
execute if score @e[tag=switch1,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=1}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch2,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=2}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch3,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=3}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch4,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=4}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch5,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=5}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch6,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=6}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch7,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=7}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch8,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=8}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch9,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=9}] breaker run scoreboard players add progresslevel breakerprogress 1
execute if score @e[tag=switch10,limit=1] breaker = @e[tag=stage2number,limit=1,scores={breakernumber=10}] breaker run scoreboard players add progresslevel breakerprogress 1
