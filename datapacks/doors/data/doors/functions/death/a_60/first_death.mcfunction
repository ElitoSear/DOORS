...
execute at @s if score @s guiding_light_message matches 580 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a60.first_1"}'}
...
execute at @s if score @s guiding_light_message matches 710 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a60.first_2"}'}
...
execute at @s if score @s guiding_light_message matches 840 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a60.first_3"}'}
...
execute at @s if score @s guiding_light_message matches 970 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a60.first_4"}'}
...
execute if score @s guiding_light_message matches 1090 run stopsound @s * custom:music.curious_light
execute if score @s guiding_light_message matches 1090 at @s run playsound custom:music.curious_light_end master @s ~ ~ ~ 0.6

execute if score @s guiding_light_message matches 1090 run title @s times 80t 0t 0t
execute if score @s guiding_light_message matches 1090 run title @s title {"text": "\uE024"}

execute if score @s guiding_light_message matches 1170 run function doors:death/untag