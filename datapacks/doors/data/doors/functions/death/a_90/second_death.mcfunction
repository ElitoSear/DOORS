...
execute at @s if score @s guiding_light_message matches 450 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a90.second_1"}'}
...
execute at @s if score @s guiding_light_message matches 580 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a90.second_2"}'}
...
execute at @s if score @s guiding_light_message matches 710 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a90.second_3"}'}
...
execute at @s if score @s guiding_light_message matches 840 positioned ~2.15 ~1.5 ~ run data merge entity @e[tag=guiding_light_message,limit=1,sort=nearest] {text:'{"color":"#EDE5AA","translate": "death.a90.second_4"}'}
...
execute if score @s guiding_light_message matches 960 run stopsound @s * custom:music.curious_light
execute if score @s guiding_light_message matches 960 at @s run playsound custom:music.curious_light_end master @s ~ ~ ~ 0.6

execute if score @s guiding_light_message matches 960 run title @s times 80t 0t 0t
execute if score @s guiding_light_message matches 960 run title @s title {"text": "\uE024"}

execute if score @s guiding_light_message matches 1020 run function doors:death/untag